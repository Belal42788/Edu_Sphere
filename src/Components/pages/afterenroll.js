                          ...
                          <div className="col-lg-8">
                            <div className="enroll-tab-content">
                              <p>
                                ...
                                book. It has survived not’s only and five
                                centuries, but also the lea into electronic
                                typesetting, remaining priting essentially
                          ...
                          <div className="col-lg-8">
                            <div className="enroll-tab-content">
                              ...
                              <p className="text">
                                ...
                                has industry's standard dummy text ever since
                                the 1500s when andom unknown printer took a
                                galley scrambled it to make a type specimen
                                book.”
                              </p>
                              <p>
                                Lorem Ipsum is simply dummy text of the printing
                    ...
                    <div className="tab-pane fade" id="tab3">
                      <div className="certificates">
                        <div className="row">
                          <div className="col-lg-4">
                            <div className="enroll-tab-title">
                              <h3 className="title">EduSphere Certificates</h3>
                            </div>
                          </div>
                          <div className="col-lg-8">
                            <div className="enroll-tab-content">
                            ...
                            <div className="enroll-tab-content">
                              <div className="single-instructor">
                                ...
                                <p>
                                  ...
                                  since the 1500s when andom unknown printer
                                  took a galley of type scrambled it to make a
                                  type specimen book.
                                </p>
                              </div>
                              <div className="single-instructor">
              ...
              <div className="video-playlist">
                <div className="accordion" id="videoPlaylist">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <p>
                        Lesson-02: Science Fiction & Fantasy: Creating Unique
                        and Powerful Worlds
                      </p>
                      <span className="total-duration">01 hour 48 minutes</span>
                    </button>
